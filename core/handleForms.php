...
if (isset($_POST['insertApplicantBtn'])) {
    ...
    $insertApplicant = insertNewApplicant($pdo, $_POST['first_name'], $_POST['last_name'], $_POST['gender'], $_POST['age'], $_POST['email'], $_POST['contact_number'], $_POST['address'], $_POST['language_skills'], $_POST['availability'], $_POST['experience_level'], $addedBy);
...
if (isset($_POST['editApplicantBtn'])) {
    ...
    $editApplicant = editApplicant($pdo, $_POST['first_name'], $_POST['last_name'], $_POST['gender'], $_POST['age'], $_POST['email'], $_POST['contact_number'], $_POST['address'], $_POST['language_skills'], $_POST['availability'], $_POST['experience_level'], $_GET['id'], $modifiedBy);
