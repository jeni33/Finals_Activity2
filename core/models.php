...
function searchForAnApplicant($pdo, $searchQuery) {
	...
	$sql = "SELECT * FROM search_applicant WHERE 
			CONCAT(first_name, last_name, gender, age, email, contact_number, address, language_skills, availability, experience_level, date_added) 
			LIKE ?";
...
function insertNewApplicant($pdo, $first_name, $last_name, 
    $gender, $age, $email, $contact_number, $address, $language_skills, $availability, $experience_level, $added_by) {
    ...
    $executeQuery = $stmt->execute([
        ...
        $gender, $age, $email, 
        $contact_number, $address, $language_skills, $availability, $experience_level, $added_by,
    ]);
    ...
    if ($executeQuery) {
        ...
        $insertAnActivityLog = insertAnActivityLog($pdo, "INSERT", $getApplicantID['id'], 
          $getApplicantID['first_name'], $getApplicantID['last_name'], 
           $getApplicantID['gender'], $getApplicantID['age'], $getApplicantID['email'], 
           $getApplicantID['contact_number'], $getApplicantID['address'], $getApplicantID['language_skills'], 
           $getApplicantID['availability'], $getApplicantID['experience_level'], $getApplicantID['added_by'], $getApplicantID['username']);
...
function editApplicant($pdo, $first_name, $last_name, 
    $gender, $age, $email, $contact_number, $address, $language_skills, $availability, $experience_level, $id, $modified_by) {
    ...
    $executeQuery = $stmt->execute([
        $first_name, $last_name, 
        $gender, $age, $email, 
        $contact_number, $address, $language_skills, $availability, $experience_level, $modified_by, $id
    ]);
    ...
    if ($executeQuery) {
		...
		$insertAnActivityLog = insertAnActivityLog($pdo, "UPDATE", $getApplicantID['id'], 
			$getApplicantID['first_name'], $getApplicantID['last_name'], 
			$getApplicantID['gender'], $getApplicantID['age'], $getApplicantID['email'], $getApplicantID['contact_number'], $getApplicantID['address'], $getApplicantID['language_skills'], $getApplicantID['availability'], $getApplicantID['experience_level'], $_SESSION['username']);
...
function insertAnActivityLog($pdo, $id, $operation, $first_name, 
		$last_name, $gender, $age, $email, $contact_number, $address, $language_skills, $availability, $experience_level, $username) {

	$sql = "INSERT INTO activity_logs (id, operation, first_name, 
		last_name, gender, age, email, contact_number, address, language_skills, availability, experience_level, username) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";

	$stmt = $pdo->prepare($sql);
	$executeQuery = $stmt->execute([$id, $operation, $first_name, 
		$last_name, $gender, $age, $email, $contact_number, $address, $language_skills, $availability, $experience_level, $username]);
